...
{
    internal class CancelShoppingCartWorkflow
    {
        private readonly IOrdersRepository ordersRepository;
        private readonly IProductsRepository productsRepository;
        private readonly ILogger<CancelShoppingCartWorkflow> logger;

        public CancelShoppingCartWorkflow(IOrdersRepository ordersRepository, IProductsRepository productsRepository, ILogger<CancelShoppingCartWorkflow> logger)
        {
