...
{
    public class OrderModificationWorkflow
    {
        private readonly IOrdersRepository ordersRepository;
        private readonly IProductsRepository productsRepository;
        private readonly ILogger<OrderModificationWorkflow> logger;

        public OrderModificationWorkflow(IOrdersRepository ordersRepository, IProductsRepository productsRepository, ILogger<OrderModificationWorkflow> logger)
        {
